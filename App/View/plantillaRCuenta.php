...
<header class="header">
        ...
        <nav>
            <ul class="nav-links">
                <li><a href="http://localhost/Banco?C=cuentaController&M=FormularioCuenta">Crear nueva cuenta</a></li> 
                <li><a href="http://localhost/Banco?C=usuarioController&M=cerrarSesion">Cerrar sesión</a></li>
            </ul>
        </nav>
    </header>
